...
pub const FAMILY_VARIANTS: &[(&str, &[&str])] = &[
    ...
    (
        "loop-pipeline",
        &["loop-pipeline", "mutating-loop", "loop-sequence", "loop-hoist"],
    ),
];
...
pub const DISPLAY_BUCKETS: &[(&str, &str)] = &[
    ...
    ("mutating-loop", "loop-pipeline"),
    ("loop-sequence", "loop-pipeline"),
    ("loop-hoist", "loop-pipeline"),
    ("hub-file", "hub-file"),
    ("high-risk", "high-risk"),
    ("hotspot", "hotspot"),
